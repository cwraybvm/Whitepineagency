  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6 items-start">
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 space-y-4">
        <h2 className="text-xs font-bold text-white uppercase tracking-wider font-mono">Ad Swipe File Controls</h2>

        <div className="space-y-1.5">
          <label className="text-[10px] text-slate-500 font-mono uppercase">Client (for Remix Brand DNA)</label>
          <select
        ...
        <div className="space-y-1.5">
          <label className="text-[10px] text-slate-500 font-mono uppercase">Competitor Ad Image URL</label>
          <div
          ...
          {imageUrl && (
            <img src={imageUrl} alt="" className="w-full max-h-48 object-contain rounded-lg border border-slate-800" onError={() => toast.error('Could not load that image URL')} />
          )}
        </div>
        ...
        {insights && (
          <>
            <div className="space-y-1.5 pt-2 border-t border-slate-800">
              <label className="text-[10px] text-slate-500 font-mono uppercase">Your Offer (optional, sharpens the remix)</label>
              <textarea
                value={prompt}
      ...
      <div className="space-y-6">
        {insights ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={f.label} className="bg-slate-900/80 border border-slate-800 rounded-xl p-4 space-y-1">
          ...
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 min-h-[200px] flex items-center justify-center text-center text-slate-500 text-sm">
        ...
        {remix && (
          <div className="space-y-4">
            <h3 className="text-xs font-bold text-white uppercase tracking-wider font-mono">Remixed Angles</h3>
            ...
            <h3 className="text-xs font-bold text-white uppercase tracking-wider font-mono">Ad Canvas Preset</h3>
            <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-4 space-y-2">
              <p className="text-sm font-bold text-white">{remix.adPreset.metadata.headline}</p>
              <p className="text-sm text-slate-300 whitespace-pre-wrap">{remix.adPreset.content}</p>
